        ...
        <div className="overflow-hidden">
          ...
          >
            ...
            <p className="text-lg text-gray-300">
              Hello! I&#39;m{" "}
              <span className="text-[#FF9100] font-semibold">Fikri Sidqi</span>,
              a passionate Front-End Developer with more than 2 years of
              experience. I love building interactive, beautiful, and
              high-performance websites using{" "}
              <span className="text-[#FF9100]">React.js</span> and{" "}
